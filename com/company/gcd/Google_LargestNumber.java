...
/**
 * This is trick question what we need to observe that the final arr will contain all numbers which are multiple of GCD of the orginal array
 ...
 * and if you need the Kth largest number in final arr it will = (len(final_arr)-k)*GCD
